...
namespace ScreenSound.Migrations
{
    ...
    public partial class PopularTabela : Migration
    {
        ...
        {
            migrationBuilder.InsertData("Artistas", new string[] { "Nome", "Bio", "FotoPerfil" }, new object[] { "Link Park", "Linkin Park é uma banda de rock dos Estados Unidos formada em Agoura Hills, Califórnia.[10] A formação atual do grupo inclui o vocalista e multi-instrumentista Mike Shinoda, o guitarrista Brad Delson, o baixista Dave Farrell, o DJ Joe Hahn, a vocalista Emily Armstrong e o baterista Colin Brittain.", "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png" });
            ...
            migrationBuilder.InsertData("Artistas", new string[] { "Nome", "Bio", "FotoPerfil" }, new object[] { "Skillet", "Skillet é uma banda americana de rock cristão de Memphis, Tennessee, formada em 1996. A banda é composta por John Cooper (vocalista principal, baixista, e líder da banda), sua esposa Korey Cooper (guitarrista, tecladista e backing vocal), Seth Morrison (guitarrista)[1] e Jen Ledger (baterista e co-vocalista principal).", "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png" });
        }
